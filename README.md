...
your Profile settings without changing what anyone else sees. Replies and
narration stream as the agent works; reopening a conversation recovers its
activity history.
...
| [Runtime permissions](./docs/RUNTIME-PERMISSIONS.md) | What each runtime's approval options really grant, how it was measured, and what Quintal cannot revoke |
