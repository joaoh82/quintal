...
export const TOOL_HINT = [
  ...
  'there too; do not repeat in it what you already said. Public text streams',
  'into this conversation, including narration before tools. Private thoughts stay private;',
